Shader "ClaseCG/ShaderPhongReflejo"
{
    Properties
    {
        ...
        SubShader
    {
        ...
        float4 frag(vOutput input) : COLOR{
			...
			float3 direccionReflejo = reflect(input.vVista, input.vNormal);
            
            return (ambiental + difuso + especular) * texCUBE(_Box, direccionReflejo) * 0.5;
        }
